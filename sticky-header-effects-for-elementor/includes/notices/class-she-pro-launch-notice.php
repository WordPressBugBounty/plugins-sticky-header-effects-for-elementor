...
if ( ! class_exists( 'She_Pro_Launch_Notice' ) ) {
	...
	class She_Pro_Launch_Notice {
		...
		public function render() {
			...
			$pricing_url = 'https://stickyheadereffects.com/?utm_source=wpbackend&utm_medium=adminbanner&utm_campaign=StickyHeaderEffectsPro&utm_content=pro_launch#pricing';
			$details_url = 'https://stickyheadereffects.com/introducing-sticky-header-effects-pro/?utm_source=wpbackend&utm_medium=adminbanner&utm_campaign=StickyHeaderEffectsPro&utm_content=viewdetails';
				...
				<div class="she-pro-notice-inner"
					...
					<div style="margin:0 10px;color:#fff;">
						...
						<p style="margin:0;color:rgba(255,255,255,0.72);font-size:13px;line-height:1.5;">
							<?php esc_html_e( '11 new effects and 50+ ready-made templates. With Sticky Until, Header Replace on Scroll, Multi-Sticky, and more. Same no-code editor.', 'she-header' ); ?>
						</p>
